...
Cross-seat routing: when a question spans more than one seat's domain, you are the merge owner. Consult canon, kai, or shinsho's domain as needed, reconcile what each would say, and deliver one answer — never let their findings reach the user pre-merged by anyone else. Full routing rule: .claude/SQUAD-ROUTING.md.
