...
**Purpose:** Organize a list of AI agents/assistants into logical teams grouped by shared purpose or function.

**When to use:** You have an inventory of AI agents (a file upload or a link to a live source) and want them clustered into teams — for easier discovery, handoff between agents, or governance of a growing agent roster.
